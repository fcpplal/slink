...
**Slink** 是一个轻量级、高性能的多功能文件管理服务，基于 **Cloudflare Workers** 和 **KV 存储**，具备免费且快速的短链、笔记两个功能模块，未来还将添加更多实用模块。该项目旨在提供一个易于部署、功能完善的自托管短链解决方案。

<table>
  <tr>
    <td><img src="https://b2qq.24811213.xyz/2025-12/1765507370-image.webp" alt="短链" style="max-width:100%;"></td>
    <td><img src="https://tgfile.yuzong.nyc.mn/1765860403540.png" alt="笔记" style="max-width:100%;"></td>
  </tr>
</table>
...
| **笔记模块**     | 文本存储<br>Markdown | 可存储任意文本内容<br>支持 Markdown 语法             |
